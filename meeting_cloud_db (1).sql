...
(9, 3, 'test set meeting', 'a@', '2016-12-01 22:00:00');
...
--
ALTER TABLE `group_leader`
  MODIFY `group_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- 使用資料表 AUTO_INCREMENT `group_member`
--
ALTER TABLE `group_member`
  MODIFY `water` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
