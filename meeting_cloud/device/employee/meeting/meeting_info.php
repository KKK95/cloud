...
//	require_once("../../../login_check.php");	
	...
	(
		...
		(
			...
			(
				...
				"addr" => "back_end/meeting/get_info/get_meeting_answer.php?meeting_id=".$meeting_id,
				"form" => array
				(
					"topic_id" => "none",																//會議議題 id
				),
	...
	if ($moderator_id == $id || $minutes_taker_id == $id)
	{
		...
		$json['form']['set_topic'] = array();
		$json['form']['set_topic']['func'] = "set_topic";									//在某個議題設定內容
		$json['form']['set_topic']['addr'] = "back_end/meeting/set_info/set_meeting_topic.php?meeting_id=".$meeting_id;
		$json['form']['set_topic']['form'] = array();
		$json['form']['set_topic']['form']['topic'] = "none";								//議題
	}
