<?php
	...
	(
		...
		(		
			...
			"get_meeting_member_list"=>"../../back_end/meeting/meeting/get_meeting_member_list.php",	//取得與會者名單
		...
		(
			...
			(
				...
				"addr" => "../../back_end/meeting/get_meeting_voting_result.php",
				"form" => array
				(
					"topic_id" => "none",
					"issue_id" => "none",
			...
			(
				...
				"addr" => "../../back_end/meeting/get_meeting_question.php",
				"form" => array
				(
					"topic_id" => "none",
				),
